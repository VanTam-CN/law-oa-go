...
const CreateCase: React.FC<CreateCaseProps> = ({ 
  ...
  // 模拟数据
  const clients = [
    { id: '1', name: '张三', type: 'PERSON', phone: '13800138001' },
    { id: '2', name: 'ABC科技有限公司', type: 'COMPANY', phone: '010-12345678' },
    { id: '3', name: '王五', type: 'PERSON', phone: '13800138002' }
  ];
                    ...
                    {lawyers.map(lawyer => (
                      <Option key={lawyer.id} value={lawyer.id}>
                        <Space>
                          ...
                          {lawyer.name}
                          <Tag color={
                            lawyer.level === 'PARTNER' ? 'red' : 
                            lawyer.level === 'SENIOR' ? 'orange' : 'blue'
                          }>
                            {lawyer.level === 'PARTNER' ? '合伙人' : 
                             lawyer.level === 'SENIOR' ? '资深律师' : '律师'}
                          </Tag>
                        </Space>
                      </Option>
                    ))}
