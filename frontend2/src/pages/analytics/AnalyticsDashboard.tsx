  ...
  const fetchAnalyticsData = async () => {
    ...
    try {
      ...
      const mockData: AnalyticsData = {
        ...
        lawyerStats: {
          topPerformers: [
            { name: '张律师', avatar: 'Z', cases: 28, hours: 420, revenue: 680000, satisfaction: 4.8 },
            { name: '李律师', avatar: 'L', cases: 24, hours: 380, revenue: 590000, satisfaction: 4.7 },
            { name: '王律师', avatar: 'W', cases: 22, hours: 350, revenue: 520000, satisfaction: 4.5 },
            { name: '赵律师', avatar: 'Z', cases: 20, hours: 320, revenue: 480000, satisfaction: 4.6 },
            { name: '陈律师', avatar: 'C', cases: 18, hours: 290, revenue: 420000, satisfaction: 4.4 }
          ],
          workload: [
                    ...
                    <List
                      ...
                      renderItem={(item, index) => (
                        <List.Item>
                          <List.Item.Meta
                            avatar={
                              <Avatar style={{ backgroundColor: index < 3 ? '#f56a00' : '#87d068' }}>
                                {item.avatar}
                              </Avatar>
                            }
                            title={
                      ...
                      {lawyerStats.workload.map((lawyer, index) => (
                        <div key={index}>
                          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                            ...
                            <Text>{lawyer.current}/{lawyer.capacity}</Text>
                          </div>
                          <Progress 
                            percent={(lawyer.current / lawyer.capacity) * 100} 
                            showInfo={false}
                            status={lawyer.current >= lawyer.capacity * 0.8 ? 'exception' : 'normal'}
                          />
                        </div>
                      ))}
                    </Space>
