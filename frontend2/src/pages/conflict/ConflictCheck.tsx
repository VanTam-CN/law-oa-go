  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // 使用静态数据避免API调用失败
        const staticUsers = [
          { id: 1, username: 'admin', real_name: '系统管理员', email: 'admin@lawfirm.com', phone: '13800138000', status: 'active', created_at: '2024-01-01 00:00:00', updated_at: '2024-01-01 00:00:00' },
          { id: 2, username: 'lawyer1', real_name: '张律师', email: 'zhang@lawfirm.com', phone: '13800138001', status: 'active', created_at: '2024-01-01 00:00:00', updated_at: '2024-01-01 00:00:00' },
          { id: 3, username: 'lawyer2', real_name: '李律师', email: 'li@lawfirm.com', phone: '13800138002', status: 'active', created_at: '2024-01-01 00:00:00', updated_at: '2024-01-01 00:00:00' }
        ];
