  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        if (statsData) {
          setKpis({
            netProfit: statsData.financeStats?.totalRevenue - statsData.financeStats?.totalExpenses || 0,
            profitMargin: statsData.financeStats?.totalRevenue > 0
              ? ((statsData.financeStats?.totalRevenue - statsData.financeStats?.totalExpenses) / statsData.financeStats?.totalRevenue * 100).toFixed(1)
              : 0,
            completionRate: statsData.totalProjects > 0
