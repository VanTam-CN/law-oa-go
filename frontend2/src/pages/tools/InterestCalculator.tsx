...
import { calculateInterest, InterestCalculatorParams, InterestCalculatorResult } from '@/services/tools';
              ...
              subTitle={
                <div className="result-content">
                  ...
                  <div className="calculation-details">
                    ...
                    <p>计算方式：{result.type === 'simple' ? '单利' : result.type === 'compound' ? '复利' : '违约金'}</p>
                  </div>
                </div>
              }
            />
