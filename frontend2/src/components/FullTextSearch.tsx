  ...
  const handleSearch = useCallback(async (pageNum: number = 1) => {
    ...
    try {
      ...
      if (showAdvanced) {
        ...
        if (searchForm.caseType) params.caseType = searchForm.caseType;
        if (searchForm.caseStatus) params.caseStatus = searchForm.caseStatus;
        if (searchForm.responsibleLawyer) params.responsibleLawyer = searchForm.responsibleLawyer;
  ...
  const columns: ColumnsType<CaseRecord> = [
    {
      ...
      render: (text, record) => (
        <SearchHighlight 
          content={text} 
          searchTerms={[searchForm.keyword]} 
          maxLength={20}
        />
      )
    },
            ...
            <Row gutter={16}>
              ...
              <Col span={6}>
                <Input
                  ...
                  onChange={(e) => setSearchForm(prev => ({ ...prev, responsibleLawyer: e.target.value }))}
                  allowClear
                />
              </Col>
              <Col span={6}>
