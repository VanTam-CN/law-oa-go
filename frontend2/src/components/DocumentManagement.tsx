...
const DocumentManagement: React.FC = () => {
  ...
  const statistics = {
    ...
    approvedDocs: documents.filter((doc) => doc.docStatus === "APPROVED")
      .length,
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (level: number) => {
        const config =
          accessLevelConfig[level as keyof typeof accessLevelConfig];
        ...
        >
          ...
          <Space>
            ...
            <Select
              ...
              onChange={(value) =>
                setFilters((prev) => ({ ...prev, docCategory: value }))
              }
            >
