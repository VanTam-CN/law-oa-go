...
const AdvancedSearch: React.FC<AdvancedSearchProps> = ({
  ...
  const handleValuesChange = (changedValues: any, allValues: any) => {
    ...
    if (allValues.searchText) filters.push("关键词");
    if (allValues.caseType) filters.push("案件类型");
    if (allValues.status) filters.push("状态");
    if (allValues.projectType) filters.push("项目类型");
    if (allValues.lawyerId) filters.push("负责律师");
    if (allValues.clientId) filters.push("客户");
    if (allValues.dateRange) filters.push("日期范围");
    if (allValues.amountRange) filters.push("金额范围");
                      ...
                      {clients.map((client) => (
                        <Option key={client.id} value={client.id}>
                          <Space>
                            ...
                            <Tag
                              color={
                                client.type === "COMPANY" ? "orange" : "blue"
                              }
                            >
