...
## Purpose
Law OA Go 是一个基于 Go 1.23+ 构建的现代化律师事务所办公自动化系统，为中小型律师事务所提供完整的数字化解决方案。项目采用单体架构设计，注重高性能、安全性和可维护性，支持案件管理、客户管理、用户管理等核心业务功能。
