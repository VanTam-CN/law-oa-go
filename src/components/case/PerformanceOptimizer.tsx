...
const PerformanceOptimizer: React.FC<PerformanceOptimizerProps> = ({
  ...
  const { metrics, isRunning, startMonitoring, stopMonitoring, run1080pTest } =
    ...
    <Card
      ...
      title={
        <Space>
          <MonitorOutlined />
          <span>性能优化器</span>
          {Display1080pOptimizer.isWithin1080pRange() && <Tag color='blue'>1080p显示器</Tag>}
        </Space>
      }
      size='small'
      extra={
    ...
    >
      ...
      <div style={{ marginBottom: 16 }}>
        <Space>
          ...
          {Display1080pOptimizer.is1080pDisplay() && <Tag color='green'>标准1080p</Tag>}
          {Display1080pOptimizer.isWithin1080pRange() &&
            !Display1080pOptimizer.is1080pDisplay() && <Tag color='orange'>1080p范围</Tag>}
        </Space>
      </div>
      ...
      <div style={{ marginBottom: 16 }}>
        ...
        <Progress
          ...
          size='small'
          status={
            performanceScore >= 80 ? 'success' : performanceScore >= 60 ? 'normal' : 'exception'
          }
