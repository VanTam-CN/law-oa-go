    ...
    ? Object.entries(statistics.projectStatus).map(([name, value]) => ({
        ...
        percentage:
          statistics.totalProjects > 0
            ? ((value / statistics.totalProjects) * 100).toFixed(1)
            : '0',
      }))
    : []
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  ...
                  <span>
                    今日待办 <strong>{todos.filter((todo) => !todo.completed).length}</strong> 项
                  </span>
              ...
              <Space direction='vertical' size={8} style={{ width: '100%' }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                    ...
                    />
                    <span style={{ fontSize: '10px', color: '#52C41A', fontWeight: '500' }}>
                      正常运行
                    </span>
                  </div>
                </div>
            ...
            <Card
              ...
              title={
                <Space>
                  ...
                  <Badge
                    count={todos.length}
                    style={{ backgroundColor: DESIGN_SYSTEM.colors.warning }}
                  />
                </Space>
              }
              style={{ border: 'none', background: 'transparent', height: 'calc(100% - 16px)' }}
                    ...
                    <div style={{ width: '100%' }}>
                      ...
                      <div style={{ fontSize: '11px', color: '#6b7280' }}>
                        <Space split={<span style={{ color: '#d1d5db' }}>|</span>}>
                          <span>
                            <CalendarOutlined style={{ fontSize: '9px' }} /> {item.deadline}
                          </span>
                          <span>
                            <UserOutlined style={{ fontSize: '9px' }} /> {item.assignee}
                          </span>
                        </Space>
                      </div>
                    </div>
