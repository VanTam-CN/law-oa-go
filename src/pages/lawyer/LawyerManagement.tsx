    ...
    <div className='lawyer-management'>
      ...
      <Row gutter={[16, 16]} className='stats-row'>
        <Col xs={24} sm={12} md={6}>
          <Card>
            <Statistic title='律师总数' value={data.length} prefix={<UserOutlined />} />
          </Card>
        </Col>
        <Col xs={24} sm={12} md={6}>
          <Card>
        ...
        <Col xs={24} sm={12} md={6}>
          <Card>
            <Statistic title='本月新增' value={0} prefix={<ClockCircleOutlined />} />
          </Card>
        </Col>
        <Col xs={24} sm={12} md={6}>
          <Card>
            <Statistic title='待处理' value={0} prefix={<CheckCircleOutlined />} />
          </Card>
        </Col>
      </Row>
