...
// ErrDocumentPermissionUnavailable prevents the legacy permission service
// from granting, revoking, or returning synthetic permissions until a real
// document permission table and ethical-wall-aware policy are connected.
var ErrDocumentPermissionUnavailable = fmt.Errorf("DOCUMENT_PERMISSION_UNAVAILABLE: document permissions are not configured")
...
func (s *DocumentPermissionService) GrantPermission(ctx context.Context, req *PermissionRequest) (*Permission, error) {
	return nil, ErrDocumentPermissionUnavailable
	/*
...
func (s *DocumentPermissionService) RevokePermission(ctx context.Context, documentID, userID, revokedBy uint) error {
	return ErrDocumentPermissionUnavailable
	/*
...
func (s *DocumentPermissionService) CheckPermission(ctx context.Context, req *PermissionCheckRequest) (bool, error) {
	return false, ErrDocumentPermissionUnavailable
	/*
