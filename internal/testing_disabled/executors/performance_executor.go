...
func NewPerformanceExecutor(options *testing.TestExecutorOptions, logger testing.TestLogger, metrics testing.TestMetrics) *PerformanceExecutor {
...
func (e *PerformanceExecutor) GetExecutorType() testing.TestType {
	return testing.TestTypePerformance
}

// Setup 设置性能测试执行器
func (e *PerformanceExecutor) Setup(ctx context.Context, executionCtx *testing.ExecutionContext) error {
	// 调用基础设置
...
// Teardown 清理性能测试执行器
func (e *PerformanceExecutor) Teardown(ctx context.Context, executionCtx *testing.ExecutionContext) error {
...
func (e *PerformanceExecutor) executeMainTest(ctx context.Context, test *testing.TestCase, result *testing.TestResult, executionCtx *testing.ExecutionContext) error {
...
// runTest 运行测试
func (w *PerformanceWorker) runTest(test *testing.TestCase, executionCtx *testing.ExecutionContext) error {
	for {
		select {
		case <-w.ctx.Done():
			return nil
...
func (w *PerformanceWorker) executeRequest(test *testing.TestCase, executionCtx *testing.ExecutionContext) (*http.Response, error) {
	// 构建请求
...
func (e *PerformanceExecutor) ExecuteNavigate(ctx context.Context, step testing.TestStep, executionCtx *testing.ExecutionContext) error {
	return fmt.Errorf("navigate step not applicable for performance tests")
}

// ExecuteClick 执行点击步骤（性能测试中不适用）
func (e *PerformanceExecutor) ExecuteClick(ctx context.Context, step testing.TestStep, executionCtx *testing.ExecutionContext) error {
	return fmt.Errorf("click step not applicable for performance tests")
}

// ExecuteFill 执行填充步骤（性能测试中不适用）
func (e *PerformanceExecutor) ExecuteFill(ctx context.Context, step testing.TestStep, executionCtx *testing.ExecutionContext) error {
	return fmt.Errorf("fill step not applicable for performance tests")
}

// ExecuteWait 执行等待步骤
func (e *PerformanceExecutor) ExecuteWait(ctx context.Context, step testing.TestStep, executionCtx *testing.ExecutionContext) error {
	if step.Wait > 0 {
		select {
		case <-ctx.Done():
			return ctx.Err()
...
func (e *PerformanceExecutor) ExecuteScreenshot(ctx context.Context, step testing.TestStep, result *testing.TestResult) error {
	return fmt.Errorf("screenshot step not applicable for performance tests")
}

// ExecuteJavaScript 执行JavaScript步骤（性能测试中不适用）
func (e *PerformanceExecutor) ExecuteJavaScript(ctx context.Context, step testing.TestStep, result *testing.TestResult, executionCtx *testing.ExecutionContext) error {
