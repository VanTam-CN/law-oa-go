...
import {
  submitConflictApproval,
  ConflictApprovalParams,
  ConflictApprovalResult,
...
const getConflictTypeIcon = (type: string) => {
  switch (type) {
    ...
    case '当事人冲突':
      return <TeamOutlined style={{ color: '#f5222d' }} />
    case '利益关联冲突':
    ...
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '20px' }}>
      ...
      <Card
        title={
          <Space>
            ...
            <span style={{ fontSize: '16px', fontWeight: '600' }}>冲突检测结果</span>
          </Space>
        }
      ...
      <Card title='检查摘要' style={{ marginBottom: '20px' }}>
        ...
        >
          <div>
            ...
            <div>
              <Text strong>{checkId}</Text>
            </div>
          </div>
          <div>
            <Text type='secondary'>检查时间</Text>
            <div>
              <Text strong>{formatTime(checkTime)}</Text>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div>
              <Text strong>
                {checkStatistics.timeRange} · {checkStatistics.searchScope}
              </Text>
            </div>
          </div>
        </div>
      ...
      <Card title='风险评估' style={{ marginBottom: '20px' }}>
        ...
        <div style={{ marginBottom: '16px' }}>
          ...
          <Paragraph style={{ marginTop: '8px' }}>{riskAssessment.riskReason}</Paragraph>
        </div>
        ...
        {riskAssessment.riskFactors.length > 0 && (
          <div style={{ marginBottom: '16px' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <div
                      style={{
                        ...
                        height: '8px',
                        borderRadius: '50%',
                        backgroundColor: factor.includes('高风险')
                          ? '#ff4d4f'
                          : factor.includes('中风险')
                            ? '#fa8c16'
                            : factor.includes('低风险')
            ...
            <div style={{ marginTop: '8px', fontSize: '13px', color: '#374151' }}>
              <Text type='secondary' style={{ color: '#374151' }}>
      ...
      <Card title='检查统计' style={{ marginBottom: '20px' }}>
        ...
        >
          ...
          >
            ...
            <div style={{ color: '#374151', marginTop: '4px', fontSize: '14px', fontWeight: '500' }}>总检查案件</div>
          </div>
          <div
            style={{
              textAlign: 'center',
          ...
          >
            ...
            <div style={{ color: '#374151', marginTop: '4px', fontSize: '14px', fontWeight: '500' }}>客户历史案件</div>
          </div>
          <div
            style={{
              textAlign: 'center',
          ...
          >
            ...
            <div style={{ color: '#374151', marginTop: '4px', fontSize: '14px', fontWeight: '500' }}>关联方检查</div>
          </div>
          <div
            style={{
              textAlign: 'center',
          ...
          >
            ...
            <div style={{ color: '#374151', marginTop: '4px', fontSize: '14px', fontWeight: '500' }}>企业关系检查</div>
          </div>
        </div>
      </Card>
      ...
      <Card style={{ textAlign: 'center', backgroundColor: '#fafafa' }}>
        <Space size='large'>
          ...
          <Button size='large' icon={<ClockCircleOutlined />} onClick={onRetry}>
            重新检查
          </Button>
        </Space>
        ...
        {hasConflict && (
          <div style={{ marginTop: '16px' }}>
            <Text type='secondary' style={{ fontSize: '12px' }}>
              请仔细查看上述冲突案例详情，确认是否继续处理此案件。 如有疑问，请联系合规部门。
            </Text>
          </div>
        )}
      </Card>
      ...
      >
        ...
        <div style={{ marginBottom: '16px' }}>
          ...
          >
            ...
            <div>
              <strong>风险评分：</strong>
              {(riskAssessment.riskScore * 100).toFixed(1)}/100
            </div>
            <div>
              <strong>冲突案例数量：</strong>
              {conflictCases.length} 个
            </div>
            <div>
              <strong>紧急程度：</strong>
              {riskAssessment.overallRisk === 'CRITICAL' || riskAssessment.overallRisk === 'HIGH'
          ...
          <div style={{ marginTop: '8px' }}>
            {conflictCases.map((conflictCase, index) => (
              ...
              >
                <div>
                  <strong>
                    {index + 1}. {conflictCase.caseName}
                  </strong>
                </div>
                <div style={{ fontSize: '13px', color: '#374151', marginTop: '4px' }}>
                  冲突类型：{conflictCase.conflictType} | 风险等级：
                  {getRiskLevelTag(conflictCase.riskLevel)}
                </div>
            ...
            >
              ...
              <Row gutter={16}>
                <Col span={12}>
                  ...
                  <div style={{ marginTop: '4px' }}>{formatTime(approvalResult.submitTime)}</div>
                </Col>
                <Col span={12}>
                  <div>
                    <strong>预计处理时间：</strong>
                  </div>
                  <div style={{ marginTop: '4px' }}>{approvalResult.expectedProcessingTime}</div>
                </Col>
              </Row>
            </div>
