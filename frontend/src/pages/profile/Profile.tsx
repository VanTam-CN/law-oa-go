    ...
    <div style={{ padding: '24px' }}>
      <Card title='个人中心' style={{ maxWidth: 800, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <Avatar size={100} src={avatarUrl} icon={<UserOutlined />} style={{ marginBottom: 16 }} />
          <div>
            <Upload
              name='avatar'
        ...
        <Form form={form} layout='vertical' initialValues={userData}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            ...
            >
              <Input prefix={<UserOutlined />} disabled={!editing} placeholder='请输入用户名' />
            </FormItem>
            ...
            >
              <Input prefix={<UserOutlined />} disabled={!editing} placeholder='请输入真实姓名' />
            </FormItem>
            ...
            >
              <Input prefix={<MailOutlined />} disabled={!editing} placeholder='请输入邮箱' />
            </FormItem>
            ...
            >
              <Input prefix={<PhoneOutlined />} disabled={!editing} placeholder='请输入手机号' />
            </FormItem>

            <FormItem label='部门' name='department'>
              <Input prefix={<BankOutlined />} disabled={!editing} placeholder='请输入部门' />
            </FormItem>
          ...
          <FormItem label='地址' name='address'>
            <Input disabled={!editing} placeholder='请输入地址' />
          </FormItem>

          <FormItem label='个人简介' name='bio'>
            <Input.TextArea rows={4} disabled={!editing} placeholder='请输入个人简介' />
          </FormItem>
