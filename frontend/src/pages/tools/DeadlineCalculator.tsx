      ...
      <Card title='工期计算器' style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <div>
          <Space direction='vertical' style={{ width: '100%' }}>
            ...
            >
              <strong style={{ color: '#1890ff' }}>民事诉讼时效：</strong>
              3年（自知道或应当知道权利受损之日起计算）
            </div>
            <div
              style={{
                padding: 10,
            ...
            >
              <strong style={{ color: '#1890ff' }}>劳动争议申请仲裁：</strong>
              1年（自知道或应当知道权利被侵害之日起计算）
            </div>
            <div
              style={{
                padding: 10,
            ...
            >
              <strong style={{ color: '#1890ff' }}>行政复议申请：</strong>
              60日（自知道该具体行政行为之日起计算）
            </div>
            <div
              style={{
            ...
            >
              <strong style={{ color: '#1890ff' }}>提起行政诉讼：</strong>
              6个月（自知道或应当知道作出行政行为之日起计算）
            </div>
            <div
              style={{
                padding: 10,
