  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h1>Dashboard</h1>
        <div className="text-muted">Debug: Dashboard is rendering</div>
            ...
            <Card.Body>
              <div className="d-flex justify-content-between">
                <div>
                  ...
                  <div className="number">{clientStats?.total_clients || 0}</div>
                </div>
            ...
            <Card.Body>
              <div className="d-flex justify-content-between">
                <div>
                  ...
                  <div className="number">{caseStats?.active_cases || 0}</div>
                </div>
                <div className="stat-icon">
            ...
            <Card.Body>
              <div className="d-flex justify-content-between">
                <div>
                  ...
                  <div className="number">{caseStats?.pending_cases || 0}</div>
                </div>
                <div className="stat-icon">
            ...
            <Card.Body>
              <div className="d-flex justify-content-between">
                <div>
                  ...
                  <div className="number">{caseStats?.closed_cases || 0}</div>
                </div>
                <div className="stat-icon">
            ...
            <Card.Body>
              <div className="deadline-list">
                <div className="deadline-item mb-3 p-3 border rounded">
                  <div className="d-flex justify-content-between">
                    <h6 className="mb-1">Case #1234 Hearing</h6>
