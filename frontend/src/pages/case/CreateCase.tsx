...
const CreateCase: React.FC<CreateCaseProps> = ({ visible = false, onCancel, onSuccess }) => {
    ...
    try {
      ...
      const checkSteps = [
        ...
        },
        {
          ...
          stepName: '生成检索报告',
          progress: 100,
          details: ['正在生成详细检索报告...', '汇总检索结果', '标记风险等级'],
        },
      ]
      ...
      try {
        ...
        setConflictCheckProgress({
          ...
          details: [
            ...
            backendResult.checkId?.startsWith('MOCK_')
              ? 'ℹ️ 开发模式：使用模拟数据'
              : '✅ 生产模式：真实后端数据',
          ],
          isCompleted: true,
      ...
      if (error instanceof Error) {
        ...
        errorDetails = ['未知错误类型', '请联系技术支持并提供错误信息']
      }
          ...
          >
            <Row gutter={12}>
              <Col span={24}>
                ...
                >
                  <Input placeholder='例如：武大郎 Vs 潘金莲' prefix={<FileTextOutlined />} />
                </Form.Item>
              </Col>
              ...
              <Col span={12}>
                <Form.Item label='其他当事人' name='otherParties' tooltip='可添加多个对方当事人'>
        ...
        return (
          ...
          >
            <Row gutter={12}>
              ...
              <Col span={12}>
                <Form.Item label='协办律师' name='assistingLawyers' tooltip='可选择多名协办律师'>
                  <Select
                    mode='multiple'
              ...
              <Col span={24}>
                <Form.Item
                  ...
                  tooltip='预估案件处理时长（月）'
                >
                  <InputNumber min={1} max={60} placeholder='预估工期' addonAfter='个月' />
                </Form.Item>
              </Col>
            </Row>
          </Card>
        ...
        return (
          ...
          >
            ...
            <Row gutter={16}>
                            ...
                            <div>
                              <div style={{ marginBottom: 12 }}>
                                ...
                                <ul style={{ margin: '8px 0', paddingLeft: '20px' }}>
                                  <li>
                                    已检索案件数量：
                                    {conflictCheckResult.checkDetails.totalCasesChecked} 件
                                  </li>
                                  <li>
                                    委托人历史案件：
                                    {conflictCheckResult.checkDetails.clientHistoryCases} 件
                                  </li>
                                  <li>
                                    已检索当事人：
                                    {conflictCheckResult.checkDetails.relatedPartiesChecked} 人
                                  </li>
                                  {conflictCheckResult.checkDetails.corporateRelationsChecked >
                                    0 && (
                                    <li>
                                      关联企业检索：
                                      {
                                  ...
                                  <li>
                                    检索时间范围：{conflictCheckResult.checkDetails.timeRange}
                                  </li>
                                  <li>
                                      ...
                                      <Card key={index} size='small' style={{ marginTop: 8 }}>
                                        <div style={{ fontSize: '13px' }}>
                                          ...
                                          <div>
                                            ...
                                            <Tag
                                              color={
                                                conflict.riskLevel === 'HIGH' ? 'red' : 'orange'
                                              }
                                            >
                                          ...
                                          <div>
                                            <Text strong>冲突说明：</Text>
                                            {conflict.description}
                                          </div>
                                          <div>
                                            <Text strong>案件状态：</Text>
                                            {conflict.caseStatus}
                                          </div>
                                        </div>
                                      </Card>
                              ...
                              <div>
                                ...
                                <ul style={{ margin: '8px 0', paddingLeft: '20px' }}>
                                  {conflictCheckResult.recommendations.map(
              ...
              <Col span={24}>
                <Form.Item label='风险标签' name='riskTags' tooltip='请勾选适用的风险类别'>
  ...
  return (
    <Modal
      ...
      width={{
        ...
        sm: '90vw',
        md: '85vw',
        lg: useCompactForm ? '1000px' : '900px',
        xl: useCompactForm ? '1100px' : '1000px',
        xxl: useCompactForm ? '1200px' : '1100px',
      }}
      centered
      wrapClassName='create-case-modal-wrap'
      destroyOnClose
      styles={{
        ...
        <div className='create-case-container'>
          <div className='compact-steps' style={{ marginBottom: 16 }}>
            {steps.map((step, index) => (
              <div
                key={index}
                className={`compact-step ${currentStep === index ? 'active' : currentStep > index ? 'finish' : 'wait'}`}
              >
