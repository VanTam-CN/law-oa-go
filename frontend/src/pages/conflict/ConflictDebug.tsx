    ...
    <div style={{ padding: '24px', maxWidth: '1200px' }}>
      ...
      <Card title="冲突检测测试" style={{ marginBottom: '24px' }}>
        ...
        >
          ...
          <Form.Item label="案件名称" name="project_name" rules={[{ required: true, message: '请输入案件名称' }]}>
            <Input placeholder="输入案件名称" />
          </Form.Item>

          <Form.Item label="案件类型" name="project_type" rules={[{ required: true, message: '请选择案件类型' }]}>
      ...
      {result && (
        <Card title="检测结果">
          <Descriptions bordered column={1}>
            ...
            <Descriptions.Item label="冲突等级">
              {result.conflict_level}
            </Descriptions.Item>
            <Descriptions.Item label="冲突数量">
