-- Reassign pending public-trial case approvals from the reserved system account
-- to the active trial partner account so the documented workflow is executable.
